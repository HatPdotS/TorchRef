...
class TestRestraintsBuildingFunctional:
    ...
    def test_build_restraints_from_cif(self, sample_cif_file, external_monomer_library):
        ...
        assert len(restraints.restraints) > 0

    @pytest.mark.integration
    def test_bond_restraints_built(self, sample_cif_file, external_monomer_library):
    ...
    @pytest.mark.integration
    def test_angle_restraints_built(self, sample_cif_file, external_monomer_library):
    ...
    @pytest.mark.integration
    def test_torsion_restraints_built(self, sample_cif_file, external_monomer_library):
    ...
    @pytest.mark.integration
    def test_plane_restraints_built(self, sample_cif_file, external_monomer_library):
...
class TestRestraintsDeviationsFunctional:
    ...
    @pytest.mark.integration
    def test_bond_deviations(self, sample_cif_file, external_monomer_library):
    ...
    @pytest.mark.integration
    def test_angle_deviations(self, sample_cif_file, external_monomer_library):
...
class TestRestraintsMultipleStructures:
    ...
    @pytest.mark.integration
    @pytest.mark.slow
    def test_restraints_multiple_cif_files(self, cif_dir, external_monomer_library):
...
class TestRestraintsDeviceHandling:
    ...
    @pytest.mark.integration
    def test_restraints_device_movement(self, sample_cif_file, external_monomer_library, cpu_device):
...
class TestRestraintsCIFParsing:
    ...
    @pytest.mark.integration
    def test_cif_dict_loaded(self, sample_cif_file, external_monomer_library):
    ...
    @pytest.mark.integration
    def test_unique_residues_detected(self, sample_cif_file, external_monomer_library):
