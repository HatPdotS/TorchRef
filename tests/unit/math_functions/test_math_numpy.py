"""
Unit tests for torchref.math_functions.math_numpy
...
class TestCoordinateTransformations:
    ...
    @pytest.mark.unit
    def test_get_fractional_matrix_orthorhombic(self, mock_unit_cell):
        """Test fractional matrix for orthorhombic cell."""
        from torchref.math_functions.math_numpy import get_fractional_matrix
    ...
    @pytest.mark.unit
    def test_get_inv_fractional_matrix(self, mock_unit_cell):
        """Test inverse fractional matrix."""
        from torchref.math_functions.math_numpy import (
    ...
    @pytest.mark.unit
    def test_cartesian_to_fractional(self, mock_unit_cell, random_coordinates):
    ...
    @pytest.mark.unit
    def test_fractional_to_cartesian(self, mock_unit_cell, random_fractional_coordinates):
        """Test fractional to Cartesian conversion."""
        from torchref.math_functions.math_numpy import fractional_to_cartesian
...
class TestScatteringVectors:
    ...
    @pytest.mark.unit
    def test_reciprocal_basis_matrix_orthorhombic(self, mock_unit_cell):
        """Test reciprocal basis matrix for orthorhombic cell."""
        from torchref.math_functions.math_numpy import reciprocal_basis_matrix
    ...
    @pytest.mark.unit
    def test_get_scattering_vectors(self, mock_unit_cell, mock_hkl_indices):
        """Test scattering vector calculation."""
        from torchref.math_functions.math_numpy import get_scattering_vectors
    ...
    @pytest.mark.unit
    def test_get_s(self, mock_unit_cell, mock_hkl_indices):
        """Test s (|S|) calculation."""
        from torchref.math_functions.math_numpy import get_s, get_scattering_vectors
...
class TestRFactorCalculations:
    ...
    @pytest.mark.unit
    def test_get_rfactor_identical(self, mock_fobs):
        """R-factor should be 0 for identical arrays."""
        from torchref.math_functions.math_numpy import get_rfactor
        
        fobs = mock_fobs(n_reflections=100).numpy()
        fcalc = fobs.copy()
    ...
    @pytest.mark.unit
    def test_get_rfactor_scaled(self, mock_fobs):
...
class TestRotation:
    ...
    def test_rotate_coords_identity(self, random_coordinates):
        ...
        from torchref.math_functions.math_numpy import rotate_coords_numpy
...
class TestOutlierDetection:
    ...
    def test_calc_outliers_no_outliers(self, mock_fobs):
        ...
        from torchref.math_functions.math_numpy import calc_outliers
