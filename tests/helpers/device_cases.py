...
UNCOVERED: Dict[str, str] = {
    ...
    "BhattacharyyaXrayTarget": "needs a scaler with initialised bins; buffers audited",
    ...
    "GaussianXrayTarget": "needs model + data + scaler",
    "LeastSquaresXrayTarget": "needs model + data + scaler",
    "MaximumLikelihoodXrayTarget": "needs model + data + scaler",
