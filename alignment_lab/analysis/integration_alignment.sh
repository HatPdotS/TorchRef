...
"$PY" -m pytest -c tests/pytest.ini tests/integration/alignment tests/unit/alignment tests/unit/scaling tests/unit/frf_separate --run-slow -q --tb=short 2>&1 | grep -v "^✓" | tail -60
