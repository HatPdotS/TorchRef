#!/bin/bash
# Decision gates for the two suspected-vestigial stages, over the full panel.
...
"$PY" -u alignment_lab/analysis/panel_arms.py --pdb "$PDB" --trials 10 2>/dev/null | grep '^ROW '
echo "rc=$?"
