...
reciprocal_space
    Reciprocal space utilities (use reciprocal.hkl instead).
...
New-style imports (recommended)::
    ...
    from torchref.math_functions.reciprocal import reciprocal_basis_matrix

Legacy imports (still supported)::

    from torchref.math_functions import cartesian_to_fractional_torch
    from torchref.math_functions import math_torch, math_numpy
"""

# =============================================================================
# New domain-specific submodules
# =============================================================================
from . import (
    coordinates,
    reciprocal,
...
# =============================================================================
# Normalization functions (E-values and anisotropy correction)
# =============================================================================
