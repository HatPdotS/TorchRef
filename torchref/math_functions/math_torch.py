...
.. deprecated::
    ...
    - ``torchref.math_functions.structure_factors`` - Structure factor calculations
    - ``torchref.math_functions.electron_density`` - Electron density map building
    - ``torchref.math_functions.fourier`` - FFT operations
    - ``torchref.math_functions.scattering`` - Atomic scattering factors
    - ``torchref.math_functions.alignment`` - Coordinate alignment
    - ``torchref.math_functions.metrics`` - R-factors and loss functions
    - ``torchref.math_functions.kernels`` - Optimized kernels
...
Example (new style - recommended)::
    ...
    from torchref.math_functions.coordinates import cartesian_to_fractional_torch
    from torchref.math_functions.metrics import get_rfactor_torch
...
# =============================================================================
from torchref.math_functions.coordinates import (
...
# =============================================================================
from torchref.math_functions.reciprocal import (
...
# =============================================================================
from torchref.math_functions.structure_factors import (
...
# =============================================================================
from torchref.math_functions.electron_density import (
...
# =============================================================================
from torchref.math_functions.fourier import (
    fft,
    ifft,
    get_real_grid,
    find_grid_size,
...
# =============================================================================
from torchref.math_functions.alignment import (
    rotate_coords_torch,
...
# =============================================================================
from torchref.math_functions.metrics import (
    get_rfactor_torch,
    rfactor,
    get_rfactors,
    bin_wise_rfactors,
