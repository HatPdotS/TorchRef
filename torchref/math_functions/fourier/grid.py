...
from torchref.math_functions.coordinates.transforms_torch import (
    fractional_to_cartesian_torch,
    get_fractional_matrix,
)
from torchref.math_functions.coordinates.transforms_numpy import (
...
def get_real_grid(cell=None, fractional_matrix=None, max_res=0.8, gridsize=None, device="cpu"):
    ...
    xyz_real_grid = fractional_to_cartesian_torch(xyz, cell, fractional_matrix)
