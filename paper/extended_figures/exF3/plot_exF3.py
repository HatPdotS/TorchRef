#!/usr/bin/env python3
"""Extended Figure 3: Refinement convergence traces.
...
Reads data from data/exF3_convergence.json (produced by benchmark_exF3_convergence.py).
"""
...
DATA_JSON = BASE / "exF3_convergence.json"
OUTDIR = BASE / "output"
...
def main():
    ...
    for i, (code, letter) in enumerate(zip(codes, letters)):
        ...
        plt.tight_layout()
        p = OUTDIR / f"exF3_panel_{letter.lower()}.png"
