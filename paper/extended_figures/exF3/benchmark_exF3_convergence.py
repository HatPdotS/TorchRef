#!/usr/bin/env python3
"""Collect refinement convergence data for Extended Figure 3.
...
Output: data/exF3_convergence.json

Usage:
    # Auto-select structures and extract from existing pipeline results:
    python benchmark_exF3_convergence.py

    # Specify structures manually:
    python benchmark_exF3_convergence.py --codes 138L 1A4E 3K7M

    # Point to a specific experiment directory:
    python benchmark_exF3_convergence.py --experiment paper_v1
"""
...
EXTFIG1_CSV = BASE.parent  / 'exF2/data/extfig1_rfactor_by_resolution.csv'
OUT_JSON = BASE / "exF3_convergence.json"
...
def main():
    parser = argparse.ArgumentParser(description="Convergence data for ExF 3")
