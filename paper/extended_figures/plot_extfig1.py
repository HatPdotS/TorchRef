...
DATA_CSV = BASE / "data" / "extfig1_rfactor_by_resolution.csv"
OUTDIR = BASE / "output"
...
def plot_panel(ax, d_min, delta_r, ylabel, label_letter, metric_name):
    ...
    # Running median
    xm, ym = running_median(d_min, delta_r, window=50)
...
def main():
    ...
    for delta, ylabel, letter, metric, fname in [
        (delta_rfree, "R-free", "A", "R-free", "extfig1_panel_a.png"),
        (delta_rwork, "R-work", "B", "R-work", "extfig1_panel_b.png"),
    ]:
